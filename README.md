...
Radiologists open a CT scan in OHIF and get an AI-generated segmentation overlay — either fully automatic (nnU-Net) or interactive with click/box prompts (MedSAM2 — in progress). Labels can be reviewed, corrected, and saved back to Orthanc.
